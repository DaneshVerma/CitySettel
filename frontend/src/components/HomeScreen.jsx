import { Search, Home, UtensilsCrossed, Dumbbell, Package, Heart } from "lucide-react";
      ...
      <div className="bg-white px-6 pt-6 pb-4 rounded-b-3xl shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <h1 className="text-2xl text-[#111827]">Hi, Sumit 👋</h1>
          </div>
          ...
          {combos.map((combo) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-[#6B7280] mb-3">{combo.description}</p>
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-[#2563EB]">₹{combo.price.toLocaleString()}</span>
                    <span className="text-[#6B7280] text-sm">/month</span>
                  </div>
                  <span className="text-[#2563EB] text-sm">View Details →</span>
                </div>
              </div>
            </button>
          ))}
